                            ...
                            switch ($step) {
                                case 0: {
                                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.numberofenemy = (Singleton$1(GlobalInstance).Instance.gameManagerInstance.numberofenemy + 1) | 0;
                                        ...
                                        $enumerator.current = new UnityEngine.WaitForSeconds(0.0);
                                        $step = 1;
                                        return true;
                                }
                                case 1: {
...
if ( TRACE ) { TRACE( "SingletonMono$1#Awake", this ); }
    ...
    Bridge.define("IECControl", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            monsterbackscene: null,
            firstplace: null,
            secondndplace: null
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "IECControl#init", this ); }

                this.firstplace = new UnityEngine.Vector3();
                this.secondndplace = new UnityEngine.Vector3();
                this.firstplace = new pc.Vec3( 23.7, 0, 47.8 );
                this.secondndplace = new pc.Vec3( -27.1, 0, 47.8 );
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "IECControl#Update", this ); }
            ...
            /*IECControl.moveA start.*/
            moveA: function () {
if ( TRACE ) { TRACE( "IECControl#moveA", this ); }

                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.monsterbackscene, this.secondndplace.$clone(), 1.5), DG.Tweening.Ease.Linear), Bridge.fn.bind(this, function () {
                    this.moveB();
                }));
            },
            /*IECControl.moveA end.*/

            /*IECControl.moveB start.*/
            moveB: function () {
if ( TRACE ) { TRACE( "IECControl#moveB", this ); }

                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.monsterbackscene, this.firstplace.$clone(), 2.2), DG.Tweening.Ease.Linear), Bridge.fn.bind(this, function () {
                    this.moveA();
                }));
            },
            /*IECControl.moveB end.*/
...
if ( TRACE ) { TRACE( "SingletonDontDestroyOnLoad$1#Awake", this ); }
    ...
    /*IECControl start.*/
    $m("IECControl", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":1,"n":"moveA","t":8,"sn":"moveA","rt":$n[0].Void},{"a":1,"n":"moveB","t":8,"sn":"moveB","rt":$n[0].Void},{"a":1,"n":"firstplace","t":4,"rt":$n[1].Vector3,"sn":"firstplace"},{"a":2,"n":"monsterbackscene","t":4,"rt":$n[1].Transform,"sn":"monsterbackscene"},{"a":1,"n":"secondndplace","t":4,"rt":$n[1].Vector3,"sn":"secondndplace"}]}; }, $n);
    /*IECControl end.*/
